...
bool* multu(bool output[],bool input1[],bool input2[]) // the problem does not tell for output size, so i am assuming it is 8 bits just like the rest of the functions. If this is not the case(for this and other similer functions) please further clearify the problems so that the proper results may be acheived.
{
	...
	output=mux_8bit(waist,input1[1],addu(waist2,output,input2),output); // the error is here......but....
	cout << waist2[0];
	cout << output[0];
	input2=shift_left(waist,input2);
	
	output=mux_8bit(waist,input1[2],addu(waist2,output,input2),output);
	cout << waist2[0];
	cout << output[0];
	input2=shift_left(waist,input2);
	
	output=mux_8bit(waist,input1[3],addu(waist2,output,input2),output);
	input2=shift_left(waist,input2);
	output=mux_8bit(waist,input1[4],addu(waist2,output,input2),output);
	input2=shift_left(waist,input2);
	output=mux_8bit(waist,input1[5],addu(waist2,output,input2),output);
	input2=shift_left(waist,input2);
	output=mux_8bit(waist,input1[6],addu(waist2,output,input2),output);
	input2=shift_left(waist,input2);
	output=mux_8bit(waist,input1[7],addu(waist2,output,input2),output);
